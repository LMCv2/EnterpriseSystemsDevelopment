...
<taglib:layout title="Edit Location">
  <div class="flex gap-3">
    <div>
      <form:form action="${location.id}" method="put" modelAttribute="location" class="w-xl space-y-3 rounded border border-gray-300 p-3">
        <div>
    ...
    <div>
      <div class="rounded border border-gray-300 p-3">
        <p>Created at</p>
        <p>${location.createDate}</p>
        <p>Last modified at</p>
        <p>${location.lastModifiedDate}</p>
      </div>
    </div>
  </div>
</taglib:layout>
