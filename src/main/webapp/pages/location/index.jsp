...
<taglib:layout title="Location">
  <div class="mb-3 flex justify-between">
    ...
    <a href="/location/new" class="flex items-center rounded border border-gray-300 px-3 py-2 hover:bg-gray-100">
  ...
  <div class="rounded shadow">
    <table class="w-full">
      ...
      <tr>
        ...
        <td class="px-3 py-2">
          <a class="inline-block rounded-full p-2 hover:bg-gray-100" href="/location/${location.id}">
