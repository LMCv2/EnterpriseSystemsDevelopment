      ...
      <taglib:layout title="Event">
        ...
        <nav class="bg-white border-gray-200 dark:bg-gray-900">
          <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <ul
              class="flex font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
              <li>
                <a href="/event/?activeTag=all"
                  class="block py-2 px-3 rounded-sm md:bg-transparent md:p-0 hover:bg-gray-100"
                  aria-current="page">All</a>
              </li>
              <li>
                <a href="/event/?activeTag=pending"
                  class="block py-2 px-3 rounded-sm md:bg-transparent md:p-0 hover:bg-gray-100"
                  aria-current="page">Pending</a>
              </li>
              <li>
                <a href="/event/?activeTag=shipped"
                  class="block py-2 px-3 rounded-sm md:bg-transparent md:p-0 hover:bg-gray-100">
                  Shipped</a>
              </li>
              <li>
                <a href="/event/?activeTag=delivered"
                  class="block py-2 px-3 rounded-sm md:bg-transparent md:p-0 hover:bg-gray-100">
                  Delivered</a>
              </li>
            </ul>
