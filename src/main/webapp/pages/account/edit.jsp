    ...
    <div>
      <form:form action="edit" method="put" modelAttribute="account" class="w-xl space-y-3 rounded border border-gray-300 p-3">
        <div>
          ...
          <form:input type="text" id="username" path="username" disabled="true" class="outline-hidden w-full rounded px-3 py-2 ring-1 ring-gray-300 focus:ring-2 focus:ring-amber-600" />
        </div>
        <div>
          <label for="password">Password:</label>
          <form:input type="password" id="password" path="password" class="outline-hidden w-full rounded px-3 py-2 ring-1 ring-gray-300 focus:ring-2 focus:ring-amber-600" />
        </div>
        <div>
          <label for="role">Role:</label>
          <form:select id="role" path="role" class="outline-hidden w-full rounded px-3 py-2 ring-1 ring-gray-300 focus:ring-2 focus:ring-amber-600">
            <form:options items="${role_items}" />
          </form:select>
        </div>
        <div>
          <label for="location">Location:</label>
          <form:select id="location" path="location" class="outline-hidden w-full rounded px-3 py-2 ring-1 ring-gray-300 focus:ring-2 focus:ring-amber-600">
