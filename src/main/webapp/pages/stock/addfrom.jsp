...
<taglib:layout title="Create Event">
  ...
  <form method="post" class="max-w-xl space-y-3">
    <div>
      ...
      <input type="number" id="quantity" name="quantity" min="0" class="outline-hidden mt-1 w-full rounded px-3 py-2 ring-1 ring-gray-300 focus:ring-2 focus:ring-amber-600" />
    </div>
