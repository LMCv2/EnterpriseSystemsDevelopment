  ...
  <nav class="border-gray-200 bg-white px-4 py-2.5 lg:px-6">
    ...
    >
      <a href="#" class="flex items-center">
        <img
          src="https://www.svgrepo.com/show/416476/leaf-salad-seasoning.svg"
          class="mr-3 h-6 sm:h-9"
        />
        <span class="self-center whitespace-nowrap text-xl font-semibold"
          >Acer International</span
        >
      </a>
...
<div class="flex">
  <nav class="flex flex-col p-3">
    <a href="/pages/dashboard/index.jsp">dashboard</a>
    <a href="/pages/fruit/index.jsp">fruit</a>
    <a href="/pages/user/index.jsp">user</a>
  </nav>
  <div class="p-3">
