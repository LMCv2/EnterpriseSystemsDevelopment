...
<div class="flex h-screen pt-16">
  <nav class="flex h-full w-56 flex-col gap-1 p-3 shadow">
    <c:if test="${permissions.contains('dashboard')}">
      <a href="/dashboard/" class="flex items-center rounded-lg px-3 py-3 hover:bg-gray-100 ${pageContext.request.requestURI.contains('/dashboard/')?'bg-gray-100 text-amber-600':''}">
    ...
    <c:if test="${permissions.contains('stock')}">
      <a href="/stock/" class="flex items-center rounded-lg px-3 py-3 hover:bg-gray-100 ${pageContext.request.requestURI.contains('/stock/')?'bg-gray-100 text-amber-600':''}">
    ...
    <c:if test="${permissions.contains('event')}">
      <a href="/event/" class="flex items-center rounded-lg px-3 py-3 hover:bg-gray-100 ${pageContext.request.requestURI.contains('/event/')?'bg-gray-100 text-amber-600':''}">
    ...
    <c:if test="${permissions.contains('fruit')}">
      <a href="/fruit/" class="flex items-center rounded-lg px-3 py-3 hover:bg-gray-100 ${pageContext.request.requestURI.contains('/fruit/')?'bg-gray-100 text-amber-600':''}">
    ...
    <c:if test="${permissions.contains('location')}">
      <a href="/location/" class="flex items-center rounded-lg px-3 py-3 hover:bg-gray-100 ${pageContext.request.requestURI.contains('/location/')?'bg-gray-100 text-amber-600':''}">
    ...
    <c:if test="${permissions.contains('account')}">
      <a href="/account/" class="flex items-center rounded-lg px-3 py-3 hover:bg-gray-100 ${pageContext.request.requestURI.contains('/account/')?'bg-gray-100 text-amber-600':''}">
