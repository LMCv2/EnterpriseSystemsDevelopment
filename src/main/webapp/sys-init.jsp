    ...
    <div class="rounded bg-white p-6 space-y-3">
      ...
      <form action="/" method="post" class="space-y-3">
        ...
        <div>
          ...
          <input type="text" id="username" name="username" required class="outline-hidden mt-1 w-full rounded px-3 py-2 ring-1 ring-gray-300 focus:ring-2 focus:ring-amber-600" />
        </div>
        <div>
          <label for="password">Password:</label>
          <input type="password" id="password" name="password" required class="outline-hidden mt-1 w-full rounded px-3 py-2 ring-1 ring-gray-300 focus:ring-2 focus:ring-amber-600" />
        </div>
